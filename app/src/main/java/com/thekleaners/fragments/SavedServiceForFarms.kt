...
import com.thekleaners.pojoClass.ForAddress
...
class SavedServiceForFarms : BaseNavigationFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mCardViewCar.setOnClickListener {
    ...
    private fun mCaDateEditextFunction() {
        ...
        val datePickerDialog =
            DatePickerDialog(mainActivity, DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
